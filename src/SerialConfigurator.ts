...
import concatTypedArrays from "./helpers/concatTypedArrays";
import makeUbxPkg from "./helpers/makeUbxPkg";
...
export default class SerialConfigurator {
     ...
     * Setup the device
     */
    setupDevice(pid: ProductId): void {
     ...
     */
    protected write(data: Uint8Array): this {
     ...
     * @param MessageClass Message class to enable/disable.
     * @param enabled True to enable, false to disable.
     * @returns The SerialConfigurator object.
     */
    enableMessages(MessageClass: Class<UbloxMessage>, enabled = true): this {
